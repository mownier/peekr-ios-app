...
enum ComposerStrings {
    
    static let cancelComposingNotificationRawName = "PostComposerViewController.cancelComposingNotification"
    ...
    static let shareTo = "Share To".localized()
}
